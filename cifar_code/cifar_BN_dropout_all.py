...
with graph.as_default():
    ...
    norm1 = batch_normalize(pool1, is_training=is_training, global_step=global_step, scope='bn_norm1')
    ...
    norm2 = batch_normalize(pool2, is_training=is_training, global_step=global_step, scope='bn_norm2')
    ...
    norm3_flat = tf.reshape(pool3, [-1, before_flatten_image_side_size*before_flatten_image_side_size*128])
    ...
    norm3_flat_drop = tf.nn.dropout(norm3_flat, 0.5)
    ...
    fc1_relu_drop = tf.nn.dropout(fc1_relu, 0.5)
    ...
    fc2_relu_drop = tf.nn.dropout(fc2_relu, 0.5)
